...
#include "Blink/Event/MouseEvent.h"
...
namespace Blink
{
	...
	{
		BLINK_CORE_ERROR("GLFW Error {0}: {1}", error, description);
	}
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		BLINK_CORE_INFO("Creating window {0} ({1}, {2})", props.Title, props.Width, props.Height);
